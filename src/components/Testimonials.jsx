    ...
    <section className="py-24">
        <div className="max-w-6xl mx-auto px-4 text-center">
            ...
            <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <FadeIn delay={300}><div className="bg-white p-6 rounded-xl shadow hover:shadow-lg transition">
                  ...
                  <FadeIn delay={150}><div className="bg-white p-6 rounded-xl shadow hover:shadow-lg transition">
